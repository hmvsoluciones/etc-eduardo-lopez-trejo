const URL_VCARD = 'https://hmvsoluciones.github.io/etc-eduardo-lopez-trejo/';
    ...
    if ('contacts' in navigator && 'ContactsManager' in window) {
        ...
        navigator.contacts.select(props, opts)
            .then((contacts) => {
                ...
                contact.name = "ETC Eduardo López Trejo";
                contact.tel = "+5215520731233";
                contact.email = "eduardo.neg222@gmail.com";
...
VERSION:3.0
FN:ETC Eduardo López Trejo
TEL:+5215520731233
EMAIL:eduardo.neg222@gmail.com
URL:${URL_VCARD}
END:VCARD`;
...
function compartirEnRedSocial(red) {
    let url = '';
    const texto = 'ETC Eduardo López Trejo - Negocios digitales.';
...
function compartirPorCorreo() {
    ...
    const body = encodeURIComponent(`¡Hola! Quiero compartir contigo la tarjeta digital de ETC Eduardo López Trejo. Visita: ${URL_VCARD}`);
